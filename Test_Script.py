...
perform_action((KeyboardInput, (asdfasdf)))


perform_action((Wait, (1547)))


perform_action((MouseClick, (707, 1036)))
...
prompt_user_pattern = "^user_responses\.append\(\(getframeinfo\(currentframe\(\)\)\.lineno, functions\.promptUser\(\)\)\)" 
print("Checkpoint 1")
line_num = 0
    ...
    while line_num < len(lines):
        ...
        if match != None:
            ...
            for item_num, item in enumerate(user_responses):
                print("Looping through user_responses")
